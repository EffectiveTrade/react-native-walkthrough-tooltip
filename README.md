...
| enableShadow | bool | false | Enable shadow when tooltip displayed, on IOS devices enable this make a warning: `RCTView has a shadow set but cannot calculate shadow efficiently` |
